...
public class LTFragment extends Fragment {
    ...
    Adapter adapter;
    String country="lt";
    private RecyclerView recyclerViewLt;
    private String category="general";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.fragment_lt,null);
        recyclerViewLt=v.findViewById(R.id.ltRecycler);
        modelClassesList=new ArrayList<>();
        recyclerViewLt.setLayoutManager(new LinearLayoutManager(getContext()));
